...
def test_canonical_account_pair_is_sorted_and_rejects_self_links():
    assert canonical_account_pair("sa_yt1", "sa_t1") == ("sa_t1", "sa_yt1")
    assert canonical_account_pair("sa_t1", "sa_t1") is None
