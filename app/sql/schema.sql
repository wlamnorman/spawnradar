...
CREATE INDEX IF NOT EXISTS idx_creator_games_played_account_igdb ON creator_games_played(account_id, igdb_game_id) WHERE igdb_game_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_steam_game_links_app_id
    ON steam_game_links(steam_app_id);
