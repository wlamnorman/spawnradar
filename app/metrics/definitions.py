...
MATCH_PAGES_VIEWED = CounterMetricDefinition(
    key="match_pages_viewed",
    prometheus_name="spawnradar_match_pages_viewed_total",
    help_text="Total number of match page views.",
    definition="Count once when a user views the ranked matches page for a game.",
)
